...
< / IconButton >
    < / TableCell >
        < TableCell
scope = "row" > < strong > {darf.mesRef} < / strong > < / TableCell >

                                                          < TableCell > < strong > {
                                                              darf.mesPagamento} < / strong > < / TableCell >

                                                                                                  < TableCell
className = {`alingRight
valor ${darf.opcoes.lucro < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             ...
             < TableCell
className = {`alingRight
valor ${darf.normal.lucro < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.normal.saldo < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.normal.valor < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             ...
             < TableCell
className = {`alingRight
valor ${darf.daytrade.lucro < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.daytrade.saldo < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.daytrade.valor < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             ...
             < TableCell
className = {`alingRight
valor ${darf.fii.lucro < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.fii.saldo < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.fii.valor < 0 ? "negativo": ""}`} >
< NumberFormat
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.ir.saldo < 0 ? "negativo": ""}`} >
< NumberFormat
value = {darf.ir.saldo}
displayType = {'text'}
decimalSeparator = {','}
...
prefix = {'R$'} / >
         < / TableCell >
             < TableCell
className = {`alingRight
valor ${darf.valorDevido < 0 ? "negativo": ""}`} >
< NumberFormat
