...
caminho_csv = r"C:\Users\giova\OneDrive\Documentos\anhanguera\Programação orientada a objetos para dados\Aulas\exercicios_platicos\CrinadoArqBinario.csv"
...
# Arquivos pickle são usados para serializar objetos Python
data.to_pickle(caminho_pickle)
...
print(f"Arquivo pickle salvo com sucesso em: {caminho_pickle}")
