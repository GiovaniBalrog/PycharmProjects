...
"""
pessoas = {'nome': 'giovani', 'sexo': 'masculino', 'idade': 26}
'''print(pessoas.keys())'''
#   del.pessoas['sexo']     '''para apagar '''
#   pessoas.keys()  ''' print chaves  '''
#   pessoas.values()    ''' print valores '''
#   pessoas.items()     ''' print items '''
for k, v in pessoas.items():
    print(f'{k} = {v} ' )       #print chaves valores items

"""

'''
brasil = []
estado1 = {'uf': 'Rio De Janeiro', 'sigra': 'RJ'}
estado2 = {'uf': 'São Paulo', 'sigra': 'SP'}
